      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">문의</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            ...
            <p style="font-family: 'ibm';">1:1 문의사항</p>
          </div>
          <div class="col-md-12">
            ...
            <form action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-lg-12">
                    <button class="btn btn-primary btn-lg btn-block" onclick="check()"
                      style="background-color:#62b43f ; border-color: #62b43f; color: whitesmoke; height: 60px; font-family: 'ibm';">글쓰기</button>
                  </div>
                </div>
              </div>
            </form>
