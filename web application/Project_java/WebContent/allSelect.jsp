...
<body>
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0">
            ...
            <strong class="text-black">회원관리</strong>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12" style="font-family: 'ibm';">
                        <h2 class="h3 mb-5 text-black">전체회원 검색</h2>
                    </div>
                    <div class="col-md-12">
                        <form action="#" method="post">
			...
			<%
			// db에 입력하는 값이 없을 땐 servlet파일 만들 필요 없음
			
			DAO dao = new DAO();
			ArrayList<VO> arr = dao.select();
			
			for(int i=0; i<arr.size(); i++){
				%>
				<tr>
		         <td style=text-align: center;> <%=arr.get(i).getId() %>   </td>
		         <td style=text-align: center;> <%= arr.get(i).getPhone()%> </td>
		         <td style=text-align: center;> <%= arr.get(i).getGender()%></td>
		         <td style=text-align: center;> <%= arr.get(i).getBirth()%></td>
		         <td style=text-align: center;><a href='DeleteCon.do?id='<%= arr.get(i).getId() %>
		         style="color: #62b43f; font-family: 'ibm';">삭제</a></td>
		         </tr>
		         <%
			}
			%>
