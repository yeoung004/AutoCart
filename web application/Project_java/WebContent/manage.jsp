...
<body>
   ...
   %>
				...
				<div class="row">
					<div class="col-md-12 mb-0">
						<a href="main.jsp" style="color: #62b43f;">Home</a> <span
							class="mx-2 mb-0">/</span> <strong class="text-black">회원관리</strong>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="site-section">
			<div class="container">
				<div class="row">
					<div class="col-md-12" style="font-family: 'ibm';">
						<h2 class="h3 mb-5 text-black">회원관리</h2>
					</div>
					<div class="col-md-12">
						<form action="#" method="post">
							<div class="p-3 p-lg-5 border">
								<div class="form-group row" style="font-family: 'ibm';">
									...
									<nav>
										<ul class="dropdowny" style="list-style: none; width: 1000px;">
											<li style="width: 100%;"><input type="search" id="sser"
												placeholder="검색할 아이디 입력"
												style="display: inline; width: 50%; outline: none; height: 67px; border-color: whitesmoke; background-color: whitesmoke;">
												<input type="submit"
												style="display: inline; width: 20%; margin-right: 5px; height: 67px; color: white; background-color: #62b43f; border-color: #62b43f;"
												value="검색" class="btn btn-primary btn-lg btn-block">
												<input type="submit"
												style="display: inline; width: 20%; margin-top: 0px; height: 67px; color: white; background-color: #62b43f; border-color: #62b43f;"
												value="전체검색" class="btn btn-primary btn-lg btn-block">
											</li>
										</ul>
									</nav>
