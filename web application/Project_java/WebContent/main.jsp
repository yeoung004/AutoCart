...
<body>
	...
	%>
		...
		<div id="siteGuide">
        <a href="#" class="guideBtn"></a>
        <p class="txt">처음이신가요?</p>
     </div>
     <div id="guidePage">
        <div class="inner">
           <img src="images/allabout1.PNG" alt="사이트안내" class="info_page">
						...
						<div class="site-block-cover-content text-center"
							style="font-family: 'ibm';">
							 <div id="home-news">
								...
								<%if(vo!=null){ %>
								<p>
									<a href="cart.jsp" class="btn btn-primary px-5 py-3"
										style="background-color: #62b43f; border-color: #62b43f; color: whitesmoke;">My
										Page</a>
								</p>
								<%} %>
						</div>
		...
		<div class="site-section" style="line-height: 0;">
			<div class="container">
				<figure class="snip1584 section-overlap">
					<img src="images/aaa.jpg" width="315px" height="177px">
					<figcaption>
						<h3>계절별 건강 유의사항</h3>
						<h5>정보읽기</h5>
					</figcaption>
				...
				<figure class="snip1584 hover section-overlap">
					<img src="images/runners.jpg" width="315px" height="177px">
					<figcaption>
						<h3>8월의 할인코드</h3>
						<h5>AYK7214</h5>
					</figcaption>
				...
				<figure class="snip1584 section-overlap">
					<img src="images/pharmacy.jpg" width="315px" height="177px">
					<figcaption>
						<h3>오늘만 특가상품</h3>
						<h5>상품보기</h5>
					</figcaption>
