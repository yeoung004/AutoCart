    ...
    transform="translate(-226.84 62.56) rotate(-40.6)" />
        ...
        <div class="site-section">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2 class="h3 mb-5 text-black">통계보기</h2>
                    </div>
                    <div class="col-md-12">
                                ...
                                <div class="form-group row" style="margin: 0 auto;">
                                    <nav class="chart-nav" style="margin-left: 0%; font-family: 'ibm';"">
                                        ...
                                        <li class="drop"><a href="#">카테고리</a>
                                            <ul class="sub_menu">
                                                <li><a href="#">부위별 건강식품</a></li>
                                                <li><a href="#">대상별 건강식품</a></li>
                                                <li><a href="#">효능별 건강식품</a></li>
                                                <li><a href="#">다이어트 식품</a></li>
                                                <li><a href="#">에너지/비타민</a></li>
                                            </ul>
                                        </li>
                                        <li class="drop""><input type=" submit"
                                            style="height:67px; color:white ;background-color: #62b43f; border-color: #62b43f;"
                                            value="검색" class="btn btn-primary btn-lg btn-block"></a>
                                        </li>
                                        </ul>
                                    </nav>
                                    <div class="chart-box-wrap" style="height: 100%; width: 100%;">
                                        <div class="chart-box-inner">
                                            ...
                                            <div class="chart-age">
                                                ...
                                                <!-- [D] 가장 낮은 그래프 : chart-progress-lower 추가 -->
                    ...
                    <div class="col-md-12">
                        <p>
                            ...
                            with <i class="icon-heart" aria-hidden="true"></i> by <a href="https://colorlib.com"
                                target="_blank" style="color: #62b43f; font-family: 'ibm';">우리팀명이 모냐구</a>
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
